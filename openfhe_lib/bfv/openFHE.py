...
def generate_keys():
    """ Just a python wrapper to run ./build/key_gen. After running this files, it will
        ...
        - `crypto_context.txt` : contain BFV CryptoContext object
        - `public_key.txt`     : contain BFV public key
        - `private_key.txt`    : contain BFV private key
        - `mult_key.txt`       : contain BFV multiplication key
    """
